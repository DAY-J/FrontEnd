...
import com.dayj.dayj.utils.Extensions.asMultipart
import com.dayj.dayj.utils.Extensions.extractInteger
        ...
        viewModelScope.launch {
            loungeRepository.writePosting(
                ...
                images = images.value.map {
                    val currentDate = com.dayj.dayj.utils.DateUtils.dateFormat.format(Date()).extractInteger()
